...
const CourseSidebarChapterItem = ({
  courseId,
  id,
  isCompleted,
  isLocked,
  ...
  return (
    <button onClick={onClick} type="button" className={cn(
      "flex items-center pl-6 gap-x-2 text-slate-500 text-sm font-[500] transition-all hover:text-slate-600 hover:bg-slate-300/20",
